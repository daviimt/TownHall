...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests((requests) -> requests
				...
				.permitAll().requestMatchers("/users/listUsers","/users/formUser/**","/deleteUser/**","/activateUser/**","/users/formUser","/addUser","/addManager","/listUsers").hasAuthority("ROLE_ADMIN").anyRequest()
				.authenticated())
